...
{
	//cet object sert à modifier le nom des variable
	public class panelEQoVariableEdit
	{
		private EQoVariable zzzTheVariable;
		public EQoVariable TheVariable { get { return this.zzzTheVariable; } }
		...
		public void ShowDialog()
		{
			...
			this.namebox.Text = this.TheVariable.Name;
		...
		//void new()
		public panelEQoVariableEdit(EQoVariable StartVariable)
		{
		...
		private void voidOkButton()
		{
			...
			else
			{
				...
				{
					this.TheVariable.Name = this.namebox.Text;
					this.forme.Close();
				}
				else
				{
