...
{
	public class panelEQoIntegralEdit
	{
		...
		public void ShowDialog()
		{
			...
			this.namebox.Text = this.TheInte.VarName;
		...
		//void new()
		public panelEQoIntegralEdit(EQoIntegral StartInte)
		{
		...
		private void voidOkButton()
		{
			...
			else
			{
				...
				{
					this.TheInte.VarName = this.namebox.Text;
					this.forme.Close();
				}
				else
				{
