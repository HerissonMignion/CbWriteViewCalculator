...
{
	public class panelEQoPiProductEdit
	{
		private EQoPiProduct zzzThePi = null;
		public EQoPiProduct ThePi { get { return this.zzzThePi; } }
		...
		public void ShowDialog()
		{
			...
			this.namebox.Text = this.ThePi.VarName;
		...
		//void new()
		public panelEQoPiProductEdit(EQoPiProduct StartPi)
		{
			this.zzzThePi = StartPi;
		...
		private void voidOkButton()
		{
			...
			else
			{
				...
				{
					this.ThePi.VarName = this.namebox.Text;
					this.forme.Close();
				}
				else
				{
