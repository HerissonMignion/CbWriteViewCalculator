...
{
	public class panelEQoSigmaSummationEdit
	{
		private EQoSigmaSummation zzzTheSigma = null;
		public EQoSigmaSummation TheSigma { get { return this.zzzTheSigma; } }
		...
		public void ShowDialog()
		{
			...
			this.namebox.Text = this.TheSigma.VarName;
		...
		//void new()
		public panelEQoSigmaSummationEdit(EQoSigmaSummation StartSigma)
		{
			this.zzzTheSigma = StartSigma;
			...
			this.namebox.KeyDown += new KeyEventHandler(this.namebox_KeyDown);
		...
		private void voidOkButton()
		{
			...
			else
			{
				...
				{
					this.TheSigma.VarName = this.namebox.Text;
					this.forme.Close();
				}
				else
				{
